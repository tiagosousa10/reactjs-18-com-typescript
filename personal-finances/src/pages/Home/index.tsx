...
export const Home = () => {
  ...
  const getYears = () => { //mostrar todos os anos apos 2024
    const years = [];
  ...
  const getMonths = () => {
    const monthsArray = Array.from({length: 12}, (_, index) => {
      ...
      return {
        ...
        label: date.toLocaleString('pt-PT', {month: 'long'})
      }
    })
    ...
    <Container>
      <Header>
        <HeaderInfo>
          ...
          <HeaderSubTitle>Acompanhe o seu saldo e filtre por mês e ano com facilidade.</HeaderSubTitle>
        </HeaderInfo>
          ...
          <BodyRow>
            <InformationCard>
              ...
              <InformationCardContent>
                <InformationCardContentValue style={{color: dataDashboard.balance >= 0 ? theme.COLORS.success : theme.COLORS.danger}}
                >
