...
export const Transactions = () => {
  ...
  const handleSearch = () => {
    setTransactionsFiltered(transactions.filter(transactions => transactions.title.toLowerCase().includes(searchValue.toLowerCase())))
  }
  ...
  const handleDeleteTransaction = async (id:number) => {
    if(window.confirm('Tem a certeza que deseja excluir esta transação?')){
      ...
      setShowAlert({type:'success', message:'Transação excluida com sucesso!', show:true})
    }
  }
    ...
    <Container>
      <Header>
        <HeaderInfo>
          ...
          <HeaderSubTitle>Consulta e gerencia as tuas transações e filtra pelo titulo!</HeaderSubTitle>
        </HeaderInfo>
